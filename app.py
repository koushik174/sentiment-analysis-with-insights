...
def globalization():
    global df
    df=pd.read_csv(r'C:/Users/kowshik/Downloads/balanced_reviews.csv')
    df=df[df["overall"]!=3]
    j=0
    global a
    a={}
...
def load_model():
    ...
    global vocab
    file=open(r"C:/Users/kowshik/Downloads/feature.pkl","rb")
    vocab=pickle.load(file)
def check_review(reviewText):
    from sklearn.feature_extraction.text import TfidfTransformer
    from sklearn.feature_extraction.text import CountVectorizer
    transformer=TfidfTransformer()
    loaded_vec=CountVectorizer(decode_error="replace",vocabulary=pickle.load(open(r"C:/Users/kowshik/Downloads/feature.pkl","rb")))
